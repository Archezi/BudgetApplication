  ...
  return {
    ...
    addListItem: function(obj, type) {
      ...
      if( type === 'inc') {
        ...
        html = '<div class="list-item" id="income-%id%"><div class="item__description">%description%</div><div class="right"><div class="item__value item__value-income">%value%</div><div class="item__delete"><button type="button" class="item__delete--btn  "><svg style="width:12px;height:12px" viewBox="0 0 24 24"><path fill="#000000" d="M12,2C17.53,2 22,6.47 22,12C22,17.53 17.53,22 12,22C6.47,22 2,17.53 2,12C2,6.47 6.47,2 12,2M15.59,7L12,10.59L8.41,7L7,8.41L10.59,12L7,15.59L8.41,17L12,13.41L15.59,17L17,15.59L13.41,12L17,8.41L15.59,7Z" /></svg></button></div></div></div>'
      } else if (type === 'exp') {

        element = DOMstrings.expenseContainer;
        html = '<div class="list-item" id="%id%"><div class="item__description">%description%</div><div class="right"><div class="item__value item__value-expense">%value%</div><div class="item__delete"><button type="button" class="item__delete--btn  "><svg style="width:12px;height:12px" viewBox="0 0 24 24"><path fill="#000000" d="M12,2C17.53,2 22,6.47 22,12C22,17.53 17.53,22 12,22C6.47,22 2,17.53 2,12C2,6.47 6.47,2 12,2M15.59,7L12,10.59L8.41,7L7,8.41L10.59,12L7,15.59L8.41,17L12,13.41L15.59,17L17,15.59L13.41,12L17,8.41L15.59,7Z" /></svg></button></div></div></div>'
      }
    ...
    displayBudget: function(obj){
      ...
      document.querySelector(DOMstrings.totalExpensePercentage).innerText = obj.percentage + '%';
      // if (obj.percentage > 0) {

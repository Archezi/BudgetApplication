...
var UIController = (function(){
  ...
  return {
    ...
    displayBudget: function(obj){
      ...
      document.querySelector(DOMstrings.totalFoundsLabel).textContent = '&euro;' + obj.budget;
      document.querySelector(DOMstrings.totalIncomeLabel).textContent = '&euro;' +  obj.totalInc;
      document.querySelector(DOMstrings.totalExpenseLabel).textContent = "&euro;"+  obj.totalExp;

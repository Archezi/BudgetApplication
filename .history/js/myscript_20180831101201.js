...
var budgetController = (function(){
  ...
  return {
    ...
    calculateBudget: function() {
      ...
      data.percentage =Math.round( (data.total.exp / data.totals.inc) * 100 );
    },
    getBudget: function() {
...
var UIController = (function(){
  ...
  var DOMstrings = {
    ...
    totalExpenseLabel: '.total__expense-funds',
  ...
  return {
    ...
    displayBudget: function(obj){
      ...
      document.querySelector(DOMstrings.totalIncomeLabel).textContent = obj.budget;
      document.querySelector(DOMstrings.totalIncomeLabel).textContent = obj.budget;
      document.querySelector(DOMstrings.totalIncomeLabel).textContent = obj.budget;
      document.querySelector(DOMstrings.totalIncomeLabel).textContent = obj.budget;
